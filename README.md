...
- `JamesIves/hyrox-insights` - This will replace the placeholder with the full repo name (this includes the username), for example `JamesIves/project-starter-kit`.
